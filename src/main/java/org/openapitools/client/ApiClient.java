...
public class ApiClient {
    ...
    private String basePath = "https://cad.onshape.com/api";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.147.4893-d7846311aebf/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cad.onshape.com/api
